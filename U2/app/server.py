...
def processHome():
	...
	return '<!DOCTYPE html> ' \
           ...
           '<h1>Hi, How are you?</h1>' \
			...
			'<input id="message" maxlength="500" required="true" name="message" size="30" type="text" value=""/>' \
			'<input id="last" type="hidden" required="true" name="last" value="' + request.form['last'] + '<br>'+ request.form['message'] + '">' \
	                 '</div>' \
                    	'<div class="inputs">' \
